        ...
        <div class="well" style="margin: 0px; height: 95px; padding: 12px;">
          ...
          <div class="col-xs-12" style="padding: 8px 0px;">
            <div class="col-xs-4" style="padding: 0px;">
              <div class="col-xs-4">
                <button onclick="showLayerDialogXY('新增','System/Dict/insert','70%', '50%','3%','15%');" type="button"
        ...
        maincontent_datatable = $('#sample-table-2').dataTable(
            {
              ...
              "aoColumns" : [
                  ...
                  },
                  {
                    "mData" : "id",
                    "mRender":function (data, type, full) {
                      var view = "<a class=\"blue tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"详细信息\" onclick=\"showLayerDialogXY('详细信息','System/Dict/view?id="+data+"','70%', '50%','3%','15%');\"> <i class=\" icon-book bigger-130\"></i> </a>";
                      var edit = "<a class=\"green tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"修改\" onclick=\"showLayerDialogXY('修改','System/Dict/edit?id="+data+"','70%', '50%','3%','15%');\"> <i class=\"icon-pencil bigger-130\"></i> </a>";
                      var del = "<a class=\"red tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"删除\"  onclick=\"del('System/Dict/delete?id="+data+"');\"> <i class=\"icon-trash bigger-130\"></i> </a>";
              ...
              "bSortCellsTop" : true,
			        "bStateSave" : true,
              "sAjaxSource" : 'System/Dict/listAllForJQueryDataTable',
