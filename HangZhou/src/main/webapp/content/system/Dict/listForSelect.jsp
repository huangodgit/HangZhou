			...
			<div class="col-xs-12">
				...
				<div class="well" style="margin: 0px; height: 95px; padding: 12px;">
					<div class="col-xs-12" style="padding:0px;padding-bottom:8px;">
						<div class="col-xs-2">
							<input type="text" placeholder="新闻类型" class="col-xs-12" name="name">
						</div>
						<div class="col-xs-2">
							<input type="text" placeholder="新闻代码" class="col-xs-12" name="dict.code">
						</div>
					...
					<div class="col-xs-12" style="padding: 8px 0px;"></div>
				...
				maincontent_datatable = $('#sample-table-2').dataTable(
						{
							...
							"aoColumns" : [
									...
									},
									{
										"mData" : "id",
										"mRender":function (data, type, full) {
											var view = "<a class=\"blue tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"详情\" onclick=\"showLayerDialog('详细信息','System/DictType/view?id="+data+"','500px','400px');\"> <i class=\" icon-book bigger-130\"></i> </a>";
