...
<body id="mybody">
				...
				<div>
						...
						<form id="townAddForm" class="form-horizontal" role="form"  method="post">
							<div class="form-group">
								...
								<div class="col-xs-9">
									<input type="text" id="form-field-1" placeholder="用户组名" name="name" class="col-xs-10"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-3 control-label no-padding-right"
								...
								<div class="col-xs-9">
									<input type="text" id="userGroupName" placeholder="请选择上级用户组" class="col-xs-10 isAddSign" readonly="readonly">
									<input type="hidden" id="userGroupID" name="parentid" readonly="readonly"> 
									<a class="green tooltip-info col-xs-1" data-rel="tooltip" data-placement="top" title="" onclick="showLayerDialog('人员列表','System/UserGroup/listTreeForSelect','100%','100%');" data-original-title="添加">
	...
	<script type="text/javascript">
		...
		$(document).ready(function(e){
			$("#userGroupID").val(parent.clickedID);
			selectedID = parent.clickedID;
			$("#userGroupName").val(parent.clickedName);
		});
		</script>
