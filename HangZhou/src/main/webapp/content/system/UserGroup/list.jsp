				...
				<div class="well" style="margin:0 0 10px 0; height: 55px; padding: 3px 0 0 12px;">
						<div class="col-xs-4" style="padding: 8px 0px;">
							<div class="col-xs-4" style="padding:0px;">
								<button onclick="fixedSize('新增','System/UserGroup/insert','800','450');" type="button" class="btn btn-info btn-sm radius-4 font" style="width: 100px; padding: 1px;">
		...
		<script type="text/javascript">
			...
			function initHtmlButton(){
				$("tbody>tr").each(function(x,i){
					...
					$(this).children("td:eq(2)").html(buttonActionText(getID,$(this).attr("data-pid")));
					var b = looop2(getID);
			...
			function buttonActionText(data,parentID){
				var view = "<a class=\"blue tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"详情\" onclick=\"fixedSize('详情','System/UserGroup/view?id="+data+"','800','450');\"> <i class=\" icon-book bigger-130\"></i> </a>";
				var edit = "<a class=\"blue tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"修改\" onclick=\"fixedSize('修改','System/UserGroup/edit?id="+data+"','800','450');\"> <i class=\" icon-pencil bigger-130\"></i> </a>";
				var userList = "<a class=\"green tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"增删用户\" onclick=\"fixedSize('增删用户','System/UserGroup/userList?id="+data+"','1000','650');\"> <i class=\"icon-hand-right bigger-130\"></i> </a>";
				var del = "<a class=\"red tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"删除\" onclick=\"fixedSizeDialog('System/UserGroup/delete?id="+data+"',this);\"> <i class=\"icon-trash bigger-130\"></i> </a>";
				return "<div>"+view+edit+userList+del+"</div>";
			}
		</script>
