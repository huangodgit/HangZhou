				...
				<div>
						...
						<form id="townAddForm" class="form-horizontal" role="form"  method="post">
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									<input type="text" id="form-field-1" placeholder="功能名" name="name" class="col-xs-10" value='<s:property value="name"/>'/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-3 control-label no-padding-right"
								...
								<div class="col-xs-9">
									<input type="text" id="form-field-1" placeholder="代号" name="description" class="col-xs-10" value='<s:property value="description"/>'/>
								</div>
							</div>
							...
							<%-- <div class="form-group">
								...
								<div class="col-xs-9">
									<input type="text" id="roleName" placeholder="请选择上级角色" name="OrgNames" class="col-xs-10 isAddSign" readonly="readonly" value='<s:property value="parent.name"/>'>
									<input type="hidden" id="roleID" name="parentid" readonly="readonly" value='<s:property value="parent.id"/>'> 
