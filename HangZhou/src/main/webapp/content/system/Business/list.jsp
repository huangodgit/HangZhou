            ...
            <form id="maincontent_dataserchform">
                <div class="well" style="margin: 0px; height: 95px; padding: 12px;">
                    <div class="col-xs-12" style="padding: 0px; padding-bottom: 8px;">
                        ...
                        <div class="col-xs-2">
                            <input type="text" id="form-field-1" placeholder="公司" class="col-xs-12" name="company">
                        </div>
                        <div class="col-xs-1">
                ...
                <div class="well" style="margin: 0px; height: 95px; padding: 12px;">
                    ...
                    <div class="col-xs-12" style="padding: 8px 0px;">
                        <div class="col-xs-4" style="padding: 0px;">
                            <div class="col-xs-4">
                                <button onclick="showLayerDialogXY('新增','System/Business/insert','70%', '50%','3%','15%');"
                                        type="button"
...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        ...
        maincontent_datatable = $('#sample-table-2').dataTable(
            {
                "oLanguage": { // 汉化
                    "scrollY": 200,//垂直滚动，指定高度
                    "scrollCollapse": true,//当显示更少的记录时，允许表格减少高度
                    "jQueryUI": true,//使用 jQuery的UI theme
                    "bSort": true,//启动各个字段的排序功能
                    "sProcessing": "正在加载数据...",
                ...
                "aoColumns": [
                    ...
                    {
                        "mData": "specialCondition.state",
                        "mRender": function (data, type, full) {
                            return "<span class='tableSpan'>" + data + "</span>";
                        }
                    },
                    {
                        "mData": "specialCondition.description",
                        "mRender": function (data, type, full) {
                            return "<span class='tableSpan'>" + data + "</span>";
                        }
                    },
                    {
                        "mData": "id",
                        "mRender": function (data, type, full) {
                            var view = "<a class=\"blue tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"详细信息\" onclick=\"showLayerDialogXY('详细信息','System/Business/view?id=" + data + "','70%', '50%','3%','15%');\"> <i class=\" icon-book bigger-130\"></i> </a>";
                            var edit = "<a class=\"green tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"修改\" onclick=\"showLayerDialogXY('修改','System/Business/edit?id=" + data + "','70%', '50%','3%','15%');\"> <i class=\"icon-pencil bigger-130\"></i> </a>";
                            var image = "<a class=\"orange tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"图片详情\" onclick=\"showLayerDialogXY('图片详情','System/Business/image?id=" + data + "','50%', '70%','3%','15%');\"> <i class=\"icon-picture bigger-130\"></i> </a>";
                            var del = "<a class=\"red tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"删除\"  onclick=\"del('System/Business/delete?id=" + data + "');\"> <i class=\"icon-trash bigger-130\"></i> </a>";
                            return "<div class=\"action-buttons\">" + view + edit + image + del + "</div>";
                        }
                    }
                ],
                ...
                "bSortCellsTop": true,
                "bStateSave": true,
                "sAjaxSource": 'System/Business/listAllForJQueryDataTable',
