				...
				<div>
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="hidden" name="projectStatus" value="DECIDED">
								<div class="col-xs-9">
									<input type="text" id="projectName" placeholder="输入名称" name="projectName" class="col-xs-10"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 control-label no-padding-right"
							...
							<div class="form-group">
								...
								<input class="form-control date-picker" name="startDate" placeholder="点击选择开始时间" readonly id="form-field-DatePicker" type="text"> <span class="input-group-addon"> <i class="icon icon-calendar bigger-110"></i>
										</span>
									</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-9">
									<textarea class="form-control limited istextarea" id="editor1" maxlength="600" rows="5" name="explanation" style="width:250px;"></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									<input type="text" id="investmentCapital" placeholder="输入投资金额" name="investmentCapital" class="col-xs-10"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									<input type="text" id="form-field-1" placeholder="输入建设单位" name="constructionUnit" class="col-xs-10"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="input-group isdatepicker" style="margin-left:20px;">
								<input class="form-control date-picker" name="planFinishedDate" placeholder="选择计划完成时间" readonly id="form-field-DatePicker" type="text"> <span class="input-group-addon"> <i class="icon icon-calendar bigger-110"></i>
										</span>
									</div>
							</div>
							<div class="form-group">
								...
								<div class="input-group isdatepicker" style="margin-left:20px;">
								<input class="form-control date-picker" name="FinishedDate" placeholder="选择完工时间" readonly id="form-field-DatePicker" type="text"> <span class="input-group-addon"> <i class="icon icon-calendar bigger-110"></i>
										</span>
									</div>
							</div>
