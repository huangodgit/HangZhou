					...
					<hr class="width-100" style="margin: 0px; border-top: 1px solid #d5e3ef;">
						<div class="col-xs-4" style="padding: 8px 0px;">
							<div class="col-xs-4" style="padding:0px;">
								<button onclick="fixedSize('新增','BaseInfo/PartyMember/insert','900','620');" type="button" class="btn btn-info btn-sm radius-4 font" style="width: 100px; padding: 1px;">
				...
				maincontent_datatable = $('#sample-table-2').dataTable(
						{
							...
							"aoColumns" : [
									...
									},
									{
										...
										"bSortable" : false,
										"mRender":function (data, type, full) {
											var view = "<a class=\"blue tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"详情\" onclick=\"fixedSize('详情','BaseInfo/DangYuan/view?id="+data+"','800','650');\"> <i class=\" icon-book bigger-130\"></i> </a>";
											var edit = "<a class=\"blue tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"修改\" onclick=\"fixedSize('修改','BaseInfo/DangYuan/edit?id="+data+"','800','540');\"> <i class=\" icon-pencil bigger-130\"></i> </a>";
											var del = "<a class=\"red tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"\" onclick=\"fixedSizeDialog('BaseInfo/DangYuan/delete?id="+data+"',this);\"> <i class=\"icon-trash bigger-130\"></i> </a>";
							...
							"bDestroy" : true,
							"bSortCellsTop" : true,
							"sAjaxSource" : 'BaseInfo/DangYuan/listAllForJQueryDataTable',
