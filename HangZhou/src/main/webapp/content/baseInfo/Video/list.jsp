			...
			<div class="col-xs-12">
				...
				<div class="well" style="margin: 0px; height: 95px; padding: 12px;">
					<div class="col-xs-12" style="padding: 0px; padding-bottom: 8px;">
						<div class="col-xs-3">
							<input type="text" id="form-field-1" placeholder="名称" name="name"
								class="col-xs-12">
						</div>
						<div class="col-xs-1">
					...
					<div class="col-xs-12" style="padding: 8px 0px;">
						<div class="col-xs-4" style="padding: 0px;">
							<div class="col-xs-4">
								<button onclick="showLayerDialog('新增','BaseInfo/Video/insert','900px', '600px')" type="button" class="btn btn-info btn-sm radius-4" style="width: 100px; padding: 1px;">
				...
				maincontent_datatable = $('#sample-table-2').dataTable({
							...
							"aoColumns" : [
									...
									},
									{
										"mData" : "Id",
										"mRender":function (data, type, full) {
											var view = "<a class=\"blue tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"详细信息\" onclick=\"showLayerDialog('详情','BaseInfo/Video/view?id="+data+"','900px', '600px');\"> <i class=\" icon-book bigger-130\"></i> </a>";
											var edit = "<a class=\"green tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"修改\" onclick=\"showLayerDialog('修改','BaseInfo/Video/edit?id="+data+"','900px', '600px');\"> <i class=\"icon-pencil bigger-130\"></i> </a>";
											var del = "<a class=\"red tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"删除\"  onclick=\"del('BaseInfo/Video/delete?id="+data+"');\"> <i class=\"icon-trash bigger-130\"></i> </a>";
							...
							"bDestroy" : true,
							"bSortCellsTop" : true,
							"sAjaxSource" : 'BaseInfo/Video/listAllForJQueryDataTable',
