					...
					<form id="villageLivelihoodNewsAddForm" class="form-horizontal"
						...
						<div class="col-xs-12 no-padding-right">
							<div class="form-group">
								...
								<div class="col-xs-8">
									<input type="text" placeholder="输入编号" name="code" class="col-xs-10" disabled="true" value='<s:property value="code"/>'>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 control-label no-padding-right" for="form-field-1"> 名称</label>
								<div class="col-xs-8">
									<input type="text" placeholder="输入名字" name="name" class="col-xs-10" disabled="true" value='<s:property value="name"/>' />
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 control-label no-padding-right" for="form-field-1"> 用户</label>
								<div class="col-xs-8">
									<input type="text" placeholder="输入用户" name="user" class="col-xs-10" disabled="true" value='<s:property value="user"/>' />
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 control-label no-padding-right" for="form-field-1"> 密码</label>
								<div class="col-xs-8">
									<input type="password" placeholder="输入密码" name="password" class="col-xs-10" disabled="true" value='<s:property value="password"/>' />
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 control-label no-padding-right" for="form-field-1"> 访问地址</label>
								<div class="col-xs-8">
									<input id="videoUrl" type="text" placeholder="输入访问地址" name="url" class="col-xs-10" disabled="true" value='<s:property value="url"/>'/>
								</div>
							</div>
							<div class="form-group">
