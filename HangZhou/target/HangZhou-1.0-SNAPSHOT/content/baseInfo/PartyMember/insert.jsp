...
<body id="mybody">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div>
						...
						<form id="townAddMemberForm" class="form-horizontal" role="form"  method="post">
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									<input type="password" id="form-field-1" placeholder="性别" name="sex" class="col-xs-10"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-3 control-label no-padding-right"
						...
						<div class="col-xs-12 no-padding">
							<div class="clearfix form-actions">
								<div class="col-md-offset-3 col-md-9 pull-right">
									<button class="btn btn-info" type="button" onclick="$('#townAddMemberForm').submit();">
	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			townAddValidator = $('#townAddMemberForm').validate({
			     focusInvalid: false,
			     rules: {
			    	  name:{
						required:true		    	  
