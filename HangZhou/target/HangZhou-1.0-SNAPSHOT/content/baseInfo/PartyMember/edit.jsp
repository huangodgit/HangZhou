				...
				<div>
						...
						<input type="hidden" name="id" value='<s:property value="id"/>'/>
							<div class="form-group">
								...
								<div class="col-xs-9">
									<input type="text" id="form-field-1" placeholder="性名" name="name" value='<s:property value="name"/>' class="col-xs-10"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-3 control-label no-padding-right"
								...
								<div class="col-xs-9">
									<input type="text" id="form-field-1" placeholder="年龄" name="age" value='<s:property value="age"/>' class="col-xs-10"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-3 control-label no-padding-right"
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									<select id="form-field-1">
                                       <option selected="selected">请选择</option>
                                       <option value="YDangYuan">是</option>
                                       <option value="NDangYuan">否</option>
                                    </select>
								</div>
							</div>
		...
		jQuery(function($) {
			townAddValidator = $('#townAddForm').validate({
			     ...
			     submitHandler: function (form) {
			    	...
			    	sendAjax("BaseInfo/DangYuan/save", $(form).serialize(), function(json){
			    		 if(json.ok){
