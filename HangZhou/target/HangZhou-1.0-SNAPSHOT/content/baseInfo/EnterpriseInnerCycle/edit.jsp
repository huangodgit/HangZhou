...
<body>
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<div>
					<form id="enterpriseInnerCycleAddForm" class="form-horizontal"
						role="form" method="post"
						action="BaseInfo/EnterpriseInnerCycle/save">
						...
						<div class="col-xs-12 no-padding-right">
							...
							<div class="form-group">
							   <label class="col-xs-2 control-label no-padding-right"
									for="form-field-1">内部循环企业链名称 </label>
								<div class="col-xs-8">
									<input type="text"  placeholder="输入内部循环企业链名称 " id="name"
										name="name" class="col-xs-10" value="<s:property value='name'/>" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 control-label no-padding-right"
									for="form-field-1">企业内部循环介绍 </label>
	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			...
			nvillageAddValidator = $('#enterpriseInnerCycleAddForm')
					.validate(
							{
								focusInvalid : false,
								rules : {
								...
								submitHandler : function(form) {
									sendAjax(
											"BaseInfo/EnterpriseInnerCycle/save",
											$(form).serialize(),
											function(json) {
												if (json.status) {
