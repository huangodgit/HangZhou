                ...
                <div class="well" style="margin: 0px; height: 95px; padding: 12px;">
                    ...
                    <div class="col-xs-12" style="padding: 8px 0px;">
                        <div class="col-xs-4" style="padding: 0px;">
                            <div class="col-xs-4">
                                <button onclick="showLayerDialogXY('新增','BaseInfo/UserType/insert','70%', '50%','3%','15%');"
                                        type="button"
                            ...
                            <div class="col-xs-2" style="margin-left: 30px;">
                                <button type="button"
                                        onclick="showLayerDialog('Excel','BaseInfo/UserType/excel','60%', '60%')"
                                        class="btn btn-info btn-sm radius-4" style="width: 100px; padding: 1px;">
                                    <i class="icon-table align-top bigger-125"></i> 导入
                                </button>
                            </div>
                            <div class="col-xs-2" style="margin-left: 30px;">
                                <button type="button"
                                        class="btn btn-info btn-sm radius-4" style="width: 100px; padding: 1px;">
                                    <a href="BaseInfo/UserType/exportExcel" style="color: white;">导出Excel文件</a>
                                </button>
                            </div>
                        </div>
        ...
        maincontent_datatable = $('#sample-table-2').dataTable(
            {
                ...
                "aoColumns": [
                    ...
                    },
                    {
                        "mData": "id",
                        "mRender": function (data, type, full) {
                            var view = "<a class=\"blue tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"详细信息\" onclick=\"showLayerDialogXY('详细信息','BaseInfo/UserType/view?id=" + data + "','70%', '50%','3%','15%');\"> <i class=\" icon-book bigger-130\"></i> </a>";
                            var edit = "<a class=\"green tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"修改\" onclick=\"showLayerDialogXY('修改','BaseInfo/UserType/edit?id=" + data + "','70%', '50%','3%','15%');\"> <i class=\"icon-pencil bigger-130\"></i> </a>";
                            var del = "<a class=\"red tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"删除\"  onclick=\"del('BaseInfo/UserType/delete?id=" + data + "');\"> <i class=\"icon-trash bigger-130\"></i> </a>";
                            return "<div class=\"action-buttons\">" + view + edit + del + "</div>";
                        }
                    }
                ],
                ...
                "bSortCellsTop": true,
                "bStateSave": true,
                "sAjaxSource": 'BaseInfo/UserType/listAllForJQueryDataTable',
