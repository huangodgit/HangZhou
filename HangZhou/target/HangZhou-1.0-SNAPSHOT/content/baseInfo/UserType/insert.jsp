...
<body>
					...
					<form id="userTypeAddForm" class="form-horizontal" method="post" action="BaseInfo/UserType/save">
						<div class="col-xs-12 no-padding" style="margin-top: 40px; margin-bottom: 40px">
							...
							<div class="form-group">
								...
								<div class="col-xs-6">
									<input type="text" id="form-field-1" placeholder="输入名称" name="name" class="col-xs-12" />
								</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-6">
									<input type="text" id="code" placeholder="输入代码" name="code" class="col-xs-12" />
								</div>
							</div>
							<div class="form-group">
								<div class="col-xs-1"></div>
	...
	jQuery.validator.addMethod("code", function(value, element) {
	    ...
	    $.ajax({
	        url:"BaseInfo/UserType/validateCode?validateCode=" + $("#code").val(),
