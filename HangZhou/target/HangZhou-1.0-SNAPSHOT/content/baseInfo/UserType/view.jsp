...
<body>
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<div>
					<form id="userTypeAddForm" class="form-horizontal" method="post" action="System/UserType/save">
	...
	jQuery.validator.addMethod("code", function(value, element) {
	    ...
	    $.ajax({
	        url:"System/UserType/validateCode?validateCode=" + $("#code").val() +"&&validateId=" + $("#id").val(),
