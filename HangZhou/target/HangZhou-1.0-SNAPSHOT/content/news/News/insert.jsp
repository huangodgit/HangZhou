							...
							<div class="form-group">
								...
								<div class="col-xs-2">
									<div class="col-xs-5 no-padding">
										<input type="hidden" name="newsType" value='<s:property value="newsType"/>'>
								...
								<div class="col-xs-6">
									...
									<div class="col-xs-9">
										<input type="text"  placeholder="输入标题" name="title" class="col-xs-10" />
									</div>
								</div>
							</div>
							<div class="form-group">
