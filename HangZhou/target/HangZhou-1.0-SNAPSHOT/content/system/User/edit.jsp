				...
				<div>
						...
						<input type="hidden" name="id" value='<s:property value="id"/>'/>
							<div class="form-group">
								...
								<div class="col-xs-9">
									<input type="text" id="form-field-1" placeholder="用户名" name="loginName" value='<s:property value="loginName"/>' class="col-xs-10"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-3 control-label no-padding-right"
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									<input type="text" id="orgName" placeholder="请选择机构" name="org.name" class="col-xs-10 isAddSign" readonly="readonly" value='<s:property value="org.name"/>'>
									<input type="hidden" id="orgID" name="org.id" readonly="readonly"  value='<s:property value="org.id"/>'> 
									<a class="green tooltip-info col-xs-1" data-rel="tooltip" data-placement="top" title="" onclick="showLayerDialog('人员列表','System/Org/listTreeForSelect','100%','100%');" data-original-title="添加">
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									<input type="text" id="memberName" placeholder="请选择户内成员" name="member.name" class="col-xs-10 isAddSign" readonly="readonly" value='<s:property value="member.name"/>'>
									<input type="hidden" id="memberID" name="member.id" readonly="readonly" value='<s:property value="member.id"/>'> 
