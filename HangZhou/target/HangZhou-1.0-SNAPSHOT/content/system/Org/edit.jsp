				...
				<div>
						...
						<form id="townAddForm" class="form-horizontal" role="form"  method="post">
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									<input type="text" id="form-field-1" placeholder="机构名" name="name" class="col-xs-10" value='<s:property value="name"/>'/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-3 control-label no-padding-right"
							...
							<div class="form-group">
								...
								<div class="col-xs-9">
									<input type="text" id="orgName" placeholder="请选择上级机构" name="parentname" class="col-xs-10 isAddSign" readonly="readonly" value='<s:property value="parent.name"/>'>
									<input type="hidden" id="orgID" name="parentid" readonly="readonly" value='<s:property value="parent.id"/>'> 
