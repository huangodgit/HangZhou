						...
						<div class="col-xs-12 no-padding"
							...
							<div class="form-group">
								...
								<div class="col-xs-6">
									...
									<a class="green tooltip-info col-xs-1 " data-rel="tooltip"
										data-placement="top" style="padding-top: 5px;" title="添加"
										onclick="showLayerDialog('字典类型列表','System/DictType/listForSelect','94%','90%');">
							...
							<div class="form-group">
								...
								<div class="col-xs-6" id="status" data='<s:property value="flag"/>'>
									<div class="col-xs-6" style="margin-top:1px;font-size:14px">
									    <label><input type="radio" value="true" id="flagT" name="flag">有效</label> 
									</div>
									<div class="col-xs-6" style="margin-top:1px;font-size:14px">
									    <label><input type="radio" value="false" id="flagF" name="flag">无效</label>
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-6">
									<input type="text" id="seqno" placeholder="输入排序位"
										name="seqno" class="col-xs-12" value='<s:property value="seqno"/>' />
								</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-6">
									<input type="text" id="code" placeholder="输入代码" name="code"
										class="col-xs-12" value='<s:property value="code"/>' />
								</div>
							</div>
							<div class="form-group">
								<div class="col-xs-1"></div>
								...
								<div class="col-xs-6">
									<textarea class="form-control limited" id="editor1"
										maxlength="600" rows="5" name="remark"><s:property
