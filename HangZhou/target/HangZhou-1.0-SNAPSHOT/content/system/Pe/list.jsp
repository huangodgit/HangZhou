        ...
        <div class="well" style="margin: 0px; height: 95px; padding: 12px;">
          <div class="col-xs-12" style="padding: 0px; padding-bottom: 8px;">
           <div class="col-xs-2">
			...
			<div class="col-xs-2">
				<input type="text" id="form-field-1" placeholder="编号" class="col-xs-12" name="code">
			</div>
            <div class="col-xs-1">
          ...
          <div class="col-xs-12" style="padding: 8px 0px;">
            <div class="col-xs-4" style="padding: 0px;">
              <div class="col-xs-4">
                <button onclick="showLayerDialogXY('新增','System/Pe/insert','70%', '50%','3%','15%');" type="button"
        ...
        maincontent_datatable = $('#sample-table-2').dataTable(
            {
              ...
              "aoColumns" : [
                  ...
                  {
                      "mData" : "pespecialcondtion.createman",
                  "mRender" : function(data, type, full) {
                    return "<span class='tableSpan'>"+data+"</span>";
                  }
                },
                {
                    "mData" : "pespecialcondtion.state",
                "mRender" : function(data, type, full) {
                  return "<span class='tableSpan'>"+data+"</span>";
                }
             	},
             	{
                    "mData" : "pespecialcondtion.describel",
                "mRender" : function(data, type, full) {
                  return "<span class='tableSpan'>"+data+"</span>";
                }
             	},
             	{
                    "mData" : "pespecialcondtion.date",
                "mRender" : function(data, type, full) {
                  return "<span class='tableSpan'>"+data+"</span>";
                }
             	},
              ...
              
                  {
                    "mData" : "id",
                    "mRender":function (data, type, full) {
                      var view = "<a class=\"blue tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"详细信息\" onclick=\"showLayerDialogXY('详细信息','System/Pe/view?id="+data+"','70%', '50%','3%','15%');\"> <i class=\" icon-book bigger-130\"></i> </a>";
                      var edit = "<a class=\"green tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"修改\" onclick=\"showLayerDialogXY('修改','System/Pe/edit?id="+data+"','70%', '50%','3%','15%');\"> <i class=\"icon-pencil bigger-130\"></i> </a>";
                      var del = "<a class=\"red tooltip-info\" data-rel=\"tooltip\" data-placement=\"top\" title=\"删除\"  onclick=\"del('System/Pe/delete?id="+data+"');\"> <i class=\"icon-trash bigger-130\"></i> </a>";
              ...
              "bSortCellsTop" : true,
			        "bStateSave" : true,
              "sAjaxSource" : 'System/Pe/listAllForJQueryDataTable',
